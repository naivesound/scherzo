...
/** returns 1 if the option was added, 0 otherwise */
int fluid_settings_remove_option(fluid_settings_t *settings, char *name,
				 char *s);
...
int fluid_settings_str_equal(fluid_settings_t *settings, char *name,
			     char *value);

/** returns 1 if the value has been set, 0 otherwise */

int fluid_settings_setnum(fluid_settings_t *settings, char *name,
			  fluid_real_t val);

/** returns 1 if the value exists, 0 otherwise */

int fluid_settings_getnum(fluid_settings_t *settings, char *name,
			  fluid_real_t *val);

/** Get the default value of a string setting. */

fluid_real_t fluid_settings_getnum_default(fluid_settings_t *settings,
					   char *name);
...
void fluid_settings_foreach_option(fluid_settings_t *settings, char *name,
				   void *data,
