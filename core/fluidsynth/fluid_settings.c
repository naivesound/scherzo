...
static int fluid_settings_get(fluid_settings_t *settings, char **name, int len,
                              void **value, int *type) {
...
static int fluid_settings_set(fluid_settings_t *settings, char **name, int len,
                              void *value, int type) {
  fluid_hashtable_t *table = settings;
  int t;
  void *v;
...
/** returns 1 if the value has been registered correctly, 0
    otherwise */
int fluid_settings_register_str(fluid_settings_t *settings, const char *name,
...
/** returns 1 if the value has been register correctly, zero
    otherwise */
int fluid_settings_register_num(fluid_settings_t *settings, const char *name,
...
/** returns 1 if the value has been register correctly, zero
    otherwise */
int fluid_settings_register_int(fluid_settings_t *settings, const char *name,
